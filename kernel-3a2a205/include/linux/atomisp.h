...
#define CUSTOM_IOCTL_REG_SET	(V4L2_CID_CAMERA_LASTP1 + 22)	//ASUS_BSP++, for calibration
#define CUSTOM_IOCTL_REG_GET	(V4L2_CID_CAMERA_LASTP1 + 23)	//ASUS_BSP++, for calibration
#define CUSTOM_IOCTL_SPI_GET	(V4L2_CID_CAMERA_LASTP1 + 24)	//ASUS_BSP++, for calibration
