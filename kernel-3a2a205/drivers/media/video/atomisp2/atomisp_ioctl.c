	...
	struct v4l2_control *control)
{
	...
	case V4L2_CID_AUTO_FOCUS_STATUS: //ASUS_BSP+++
	//ASUS_BSP+++, for iCatch 3A information
	case V4L2_CID_PAN_RELATIVE: //AE1
	case V4L2_CID_TILT_RELATIVE: //AE2
	case V4L2_CID_PAN_RESET: //AWB1
	case V4L2_CID_TILT_RESET: //AWB2 and 3A version
	case V4L2_CID_PAN_ABSOLUTE: //AF1
	case V4L2_CID_TILT_ABSOLUTE: //AF2
	//ASUS_BSP---, for iCatch 3A information
	//ASUS_BSP++, for calibration
			  ...
			  struct v4l2_control *control)
{
	...
	case V4L2_CID_SATURATION:
	case V4L2_CID_SHARPNESS:
	case V4L2_CID_COLORFX: //ASUS_BSP+++
	case V4L2_CID_IRIS_RELATIVE: //ASUS_BSP+++, set ROI trigger
	case CUSTOM_IOCTL_REG_SET: 	//ASUS_BSP++, for calibration
		mutex_unlock(&isp->mutex);
